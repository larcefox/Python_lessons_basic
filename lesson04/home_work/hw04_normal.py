...
with open('newfile.txt', 'w', encoding='utf-8') as f:
       ...
       for num in [random.randint(0,9) for itm in range(2500)]:
              f.write(str(num))
...
patterns = [r'[0]+', r'[1]+', r'[2]+', r'[3]+', r'[4]+', r'[5]+', r'[6]+', r'[7]+', r'[8]+', r'[9]+',]
list_num = [max(re.findall(pattern_n, numbers)) for pattern_n in patterns]
